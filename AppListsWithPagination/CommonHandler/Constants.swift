...
struct Constants {
    ...
    */
    ...
    struct API {
        ...
        static let s_developmentBaseURL = "https://jsonplaceholder.typicode.com/" //+ s_APP_APIS_VERSION
        static let s_productionBaseURL = "https://jsonplaceholder.typicode.com/" //+ s_APP_APIS_VERSION
        ...
        static let URL_POSTS_GET_ALL_POSTS = BaseURL + "posts?_page=%@&_limit=%@"
